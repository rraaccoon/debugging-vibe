 ...
 * FireScene: 왼쪽을 보는 소방차가 왼쪽 아래 불에 물을 뿌린다. .fire-scene 안에서만 불꽃 · 물줄기 · 경광등이 움직인다(globals.css).
 */
export function FireScene({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 320 124" className={className} aria-hidden="true" focusable="false">
      <defs>
        <pattern id="fire-scene-chevron" width="12" height="8" patternUnits="userSpaceOnUse" patternTransform="skewX(-30)">
      ...
      <rect x="104" y="76" width="196" height="8" fill="url(#fire-scene-chevron)" opacity="0.9" />
